...
<body>
	<div id="wrap">
		...
		<section class="py-2">
			<form name="signupForm" onsubmit="return false" enctype="multipart/form-data">
					...
					<div class="col-5 border rounded">
						...
						<div class="d-flex px-3 py-4">
							<div>
								...
								<div class="d-flex">
									<input id="loginIdInput" class="signupInput form-control col-9 border-none" type="text" placeholder="아이디" name="loginId" />
								...
								<input id="nameInput"  class="signupInput form-control" type="text" placeholder="실명을 입력하세요." name="name" />
								
								<label class="signupLabel pt-2"> 닉네임 </label>
								<input id="nickNameInput"  class="signupInput form-control" type="text" placeholder="닉네임을 입력하세요." name="nickName" />
								 
								<label class="signupLabel pt-2"> 연락처 </label>
								<input id="phoneNumberInput"  class="signupInput form-control" type="text" placeholder="'-' 구분없이 입력" name="phoneNum"/>
								 
								<label class="signupLabel pt-2"> 생년월일 </label>
								<input id="birthInput"  class="signupInput form-control" type="text" placeholder="8자리 입력" name="birth"/>
								
								<label class="signupLabel pt-2"> 성별 </label>
								<div class="d-flex genderBox">
								    <div>
								      <input type="radio" id="man" value="남" name="gender">
								      <label for="man">남</label>
								    </div>
								    <div class="pl-3">
								      <input type="radio" id="woman" value="여" name="gender">
								...
								<input id="emailInput" class="signupInput form-control" type="text" placeholder="이메일" name="email"/>
								 
								<label class="signupLabel pt-2"> 자기소개 </label>
								<textarea class="form-control" rows="3" id="contentInput" name="content"> </textarea>
								
							</div>
						</div>
						
					<div class="d-flex justify-content-center px-3">
						<button id="signupBtn" class="col-12 ml-1" type="button" onclick="javascript:signupSubmit();"> 가입하기 </button>
					</div>
